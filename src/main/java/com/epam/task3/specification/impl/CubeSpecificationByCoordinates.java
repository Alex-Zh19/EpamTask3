...
public class CubeSpecificationByCoordinates implements CubeSpecificationInterface {
    @Override
    public boolean specified(Cube cube) throws CustomPointException {//for 1st quarter and positive z
