...
public class CustomParserTest {
    ...
    public void testParseStringsToGetTypeAndNames() {
        ...
        str1Exp[0]="cube";str1Exp[1]="name";
        String[] str2Exp=new String[2];
        str2Exp[0]="cube";str2Exp[1]="name1";
        String[] str3Exp=new String[2];
        str3Exp[0]="cube";str3Exp[1]="name2";
    ...
    public void testParseStringsToGetIntArray() {
        ...
        listExpected.add(arr1);listExpected.add(arr2);listExpected.add(arr3);
